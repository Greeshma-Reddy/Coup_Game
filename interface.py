...
character_colors = {
    'Duke': '\033[95m',  # purple
    'Assassin': '\033[91m',  # red
    'Captain': '\033[94m',  # blue
    'Ambassador': '\033[92m',  # green
    'Contessa': '\033[31m',  # dark red
}
...
def choose_character():
    ...
    print(f"Your chosen character: {character_colors[chosen_character]}{chosen_character}{reset_color}")

    return Character(chosen_character, character_colors[chosen_character])
